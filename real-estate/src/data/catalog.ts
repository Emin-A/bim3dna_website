...
const scope = (id: string, en: string, nl: string, image: string): ProjectScope => ({
  id,
  label: { en, nl },
  image,
})
  ...
  'coordination-installations': [
    {
      ...
      year: 2025,
      scopes: [
        scope('architectural-bim', 'Architectural BIM', 'Architectonische BIM', coordinationLead),
        scope('mep-coordination', 'MEP Coordination', 'MEP-coördinatie', installPrefabrication),
        scope('lod-350', 'LOD 350 Installables', 'LOD 350 Installaties', installWorkshop),
      ],
    },
    {
      ...
      scopes: [
        ...
        scope('structural-integration', 'Structural Integration', 'Constructieve integratie', installWorkshop),
        scope('installation-sequencing', 'Installation Sequencing', 'Installatiesequenties', installPrefabrication),
      ],
    },
  ],
  'architecture-delivery': [
    {
      ...
      year: 2025,
      scopes: [
        scope('concept-authoring', 'Concept Authoring', 'Conceptmodellering', architectureFeature),
        scope('facade-rationalisation', 'Facade Rationalisation', 'Geveloptimalisatie', architectureInterior),
        scope('install-interface', 'Install Interface', 'Installatie-afstemming', coordinationLead),
      ],
    },
    {
      ...
      year: 2024,
      scopes: [
        scope('spatial-programming', 'Spatial Programming', 'Ruimtelijke programmering', architectureInterior),
        scope('technical-authoring', 'Technical Authoring', 'Technische uitwerking', architectureFeature),
        scope('visualisation', 'Visualisation', 'Visualisatie', automationSuite),
      ],
    },
  ],
  'script-automation': [
    {
      ...
      scopes: [
        ...
        scope('batch-processing', 'Batch Processing', 'Batchverwerking', automationSuite),
        scope('compliance', 'Compliance Checks', 'Conformiteitscontrole', automationDashboard),
      ],
    },
    {
      ...
      year: 2024,
      scopes: [
        scope('dynamo', 'Dynamo Automation', 'Dynamo-automatisering', automationSuite),
        scope('content-automation', 'Content Automation', 'Content-automatisering', automationImg),
        scope('cost-data', 'Cost Data Binding', 'Kostendata-koppeling', automationDashboard),
      ],
    },
  ],
  'clash-detection': [
    {
      ...
      scopes: [
        ...
        scope('install-sequencing', 'Install Sequencing', 'Installatiesequenties', clashNavisworks),
        scope('navisworks', 'Navisworks Automation', 'Navisworks-automatisering', installWorkshop),
      ],
    },
    {
      ...
      scopes: [
        ...
        scope('reporting', 'Reporting Dashboards', 'Rapportage dashboards', clashNavisworks),
  ...
  'scan-to-bim': [
    {
      ...
      year: 2025,
      scopes: [
        scope('registration', 'Point Cloud Registration', 'Puntwolkregistratie', scanHeritage),
        scope('mechanical-model', 'Mechanical Model', 'Werktuigbouwkundig model', scanImg),
        scope('asset-tagging', 'Asset Tagging', 'Asset tagging', scanHealthcare),
      ],
    },
    {
      ...
      year: 2024,
      scopes: [
        scope('reality-capture', 'Reality Capture', 'Reality capture', scanHealthcare),
  ...
  'template-database': [
    {
      ...
      year: 2025,
      scopes: [
        scope('template-strategy', 'Template Strategy', 'Templatestrategie', templateImg),
        scope('content-governance', 'Content Governance', 'Content governance', templateLibrary),
    ...
    },
    {
      ...
      year: 2024,
      scopes: [
        scope('standards', 'Standards Development', 'Standaardontwikkeling', templateLibrary),
        scope('audit-automation', 'Audit Automation', 'Auditautomatisering', automationSuite),
        scope('documentation', 'Install Documentation', 'Installatiedocumentatie', templateImg),
      ],
    },
  ],
  'lifecycle-delivery': [
    {
      ...
      scopes: [
        ...
        scope('logistics', 'Logistics Simulation', 'Logistieke simulatie', lifecycleDashboard),
        scope('prefab', 'Prefab Readiness', 'Prefab gereed', installPrefabrication),
      ],
    },
    {
      ...
      year: 2024,
      scopes: [
        scope('5d-cost', '5D Cost Control', '5D-kostencontrole', lifecycleDashboard),
        scope('6d-fm', '6D FM Data', '6D-FM-data', lifecycleImg),
        scope('powerbi', 'Power BI Dashboards', 'Power BI-dashboards', automationDashboard),
      ],
    },
  ],
}
