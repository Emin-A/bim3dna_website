    ...
    <main className='bg-black text-white'>
      <section className='relative isolate overflow-hidden border-b border-white/10 py-24'>
        ...
        <div className='mx-auto flex max-w-5xl flex-col gap-8 px-6'>
          ...
          <p className='max-w-3xl text-sm text-white/70'>{labels.description}</p>
            ...
            {serviceCategories.map((category) => (
              ...
              >
                ...
                <div className='space-y-4 p-8'>
                  <h2 className='text-2xl font-semibold'>{category.title[language]}</h2>
                  <p className='text-sm text-white/70'>{category.summary[language]}</p>
